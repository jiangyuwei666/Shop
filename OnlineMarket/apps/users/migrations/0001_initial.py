    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2019, 6, 23, 20, 59, 32, 125640), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '邮箱验证码',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=50, verbose_name='邮箱')),
                ('head_img', models.ImageField(upload_to='', verbose_name='用户头像')),
